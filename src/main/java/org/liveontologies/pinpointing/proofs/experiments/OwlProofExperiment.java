...
public abstract class OwlProofExperiment<O extends OwlProofExperiment.Options>
		extends
		BaseProofExperiment<O, OWLAxiom, Inference<OWLAxiom>, OWLAxiom> {

	private static final Logger LOGGER_ = LoggerFactory
			.getLogger(OwlProofExperiment.class);
