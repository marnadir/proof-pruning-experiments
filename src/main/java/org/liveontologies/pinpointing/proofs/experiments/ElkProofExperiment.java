...
public abstract class ElkProofExperiment<O extends ElkProofExperiment.Options>
		extends
		BaseProofExperiment<O, Object, Inference<Object>, ElkAxiom> {

	private static final Logger LOGGER_ = LoggerFactory
			.getLogger(ElkProofExperiment.class);
