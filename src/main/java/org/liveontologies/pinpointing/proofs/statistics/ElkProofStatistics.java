...
public abstract class ElkProofStatistics<O extends ElkProofStatistics.Options>
		extends
		BaseProofStatistics<O, Object, Inference<Object>, ElkAxiom> {

	private static final Logger LOGGER_ = LoggerFactory
			.getLogger(ElkProofStatistics.class);
