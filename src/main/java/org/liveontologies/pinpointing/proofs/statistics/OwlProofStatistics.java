...
public abstract class OwlProofStatistics<O extends OwlProofStatistics.Options>
		extends
		BaseProofStatistics<O, OWLAxiom, Inference<OWLAxiom>, OWLAxiom> {

	private static final Logger LOGGER_ = LoggerFactory
			.getLogger(OwlProofStatistics.class);

	public static final String ONTOLOGY_OPT = "ontology";
	
	protected OWLOntologyManager manager_ = null;
